...
if __name__ == "__main__":
    ...
    clf = MLPClassifier(hidden_layer_sizes=(128, 256, 512, 256, 128, 64, 32, 16), learning_rate_init=0.0008, max_iter=300, n_iter_no_change=15, verbose=True).fit(X_train, Y_train)
